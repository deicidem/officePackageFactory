...
let microsoftPackage = OfficeProgramsPackageFactoryMaker.makeFactory(
  AvailableFactories.MICROSOFT
);
...
let googlePackage = OfficeProgramsPackageFactoryMaker.makeFactory(
  AvailableFactories.GOOGLE
);
